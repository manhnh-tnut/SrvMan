...
using SrvMan.WinService.WinApi;

using static SrvMan.WinService.WinApi.NativeMethods;

using ServiceType = SrvMan.WinService.WinApi.ServiceType;

namespace SrvMan.WinService
{
    /// <summary>
